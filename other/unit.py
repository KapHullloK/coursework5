...
class BaseUnit(ABC):
    ...
    def __init__(self, name: str, unit_class: UnitClass):
        ...
        self.weapon = Equipment().get_weapon("пика")
        self.armor = Equipment().get_armor('майка')
    ...
    def _count_damage(self, target: BaseUnit) -> int:
        # TODO происходит уменьшение выносливости атакующего при ударе
    ...
    def use_skill(self, target: BaseUnit) -> str:
        ...
        if self._is_skill_used:
            return "Вы уже использовали навык"
